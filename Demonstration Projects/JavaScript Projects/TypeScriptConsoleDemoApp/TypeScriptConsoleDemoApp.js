...
function testStringManipulation() {
    ...
    let stringMessage2 = "This message was made in a variable using Type Annotation to explicitly define it as a string";
    let stringMessage3 = "string concatenation";
    let stringMessage4 = "string interpolation";
...
const complexArrowFunctionTest = (str1, str2) => {
    return str1 + str2;
};
...
function testArrays() {
    ...
    let myArray = new Array(10); //declare an array of 10 strings
...
function generateRandomInt(minVal, maxVal) {
...
// run the program
mainFunction();
//# sourceMappingURL=TypeScriptConsoleDemoApp.js.map